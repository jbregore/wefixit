...
const ClientAppointments = ({ navigation }) => {
  ...
  const loadData = () => {
    ...
    fetch("http://192.168.42.241/wefixit/backend/api/appointments/client_fetch_my_appointments.php", {
      method: "POST",
    ...
    //FREELANCER COUNT
    fetch('http://192.168.42.241/wefixit/backend/api/users/hired_freelancer_count.php', {
      method: 'GET',
      headers: {
        //Header Defination
        'Accept': 'application/json',
  ...
  const goSendFeedback = () => {
    ...
    for (let row of sampleImage) {
      ...
      fetch('http://192.168.42.241/wefixit/backend/api/mobile_feedback_photos_upload.php', {
        method: 'POST',
        body: uploadData
      }).then(response => response.text())
        .then(responseJson => {
          ...
          fetch('http://192.168.42.241/wefixit/backend/api/appointments/create_fb_appoint.php', {
            method: 'POST',
    ...
    fetch('http://192.168.42.241/wefixit/backend/api/appointments/markasdone_appointment.php', {
      method: 'PUT',
      ...
      <View style={styles.screen}>
        <ScrollView showsVerticalScrollIndicator={false} refreshControl={
          ...
          >
            ...
            >{hiresList.length} Hired Freelancers found.</Text>
          </View>
