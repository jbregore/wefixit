...
const FreelancerViewProfile = ({ navigation, route }) => {
  ...
  const AboutMe = () => {
    return (
      ...
      >
        <Text style={styles.caption2}>
          <Text style={{ color: "#1d4354", fontWeight: "bold" }}>Rate: </Text>
          {info.rate}
        </Text>
        <Text style={styles.caption2}>
          <Text style={{ color: "#1d4354", fontWeight: "bold" }}>
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        >
          {loadingInfo === false ? (
            <>
              ...
              {profileRole === "freelancer" ? <AboutMe /> : <></>}
      ...
      {/* <PDFReader
        source={{
          uri: 'http://192.168.42.213/wefixit/backend/uploads/portfolios/61da7a4043cc83.14007386.pdf',
        }}
      /> */}
    </SafeAreaView>
  );
